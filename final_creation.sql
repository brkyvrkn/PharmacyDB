ALTER TABLE SUPPLIERS DROP CONSTRAINT SUPP_FK;
ALTER TABLE DRUG DROP CONSTRAINT DRG_FK_1;
ALTER TABLE DRUG DROP CONSTRAINT DRG_FK_2;
ALTER TABLE DRUG DROP CONSTRAINT DRG_FK_3;
...
ALTER TABLE SUPPLIERS ADD CONSTRAINT SUPP_FK
...
ALTER TABLE DRUG ADD CONSTRAINT DRG_FK_3
